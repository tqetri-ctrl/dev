...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    check_token();
    $nav_file = __DIR__ . '/navigation.json'; // 내비게이션 저장은 그대로 유지
    ...
    if (isset($_POST['nav_content'])) {
        ...
        $co_id = preg_replace('/[^a-zA-Z0-9-]/', '', $_POST['new_page_id']);
        ...
        <aside class="sidebar">
            ...
            <ul>
                <?php foreach ($pages as $page): ?>
                    ...
                    <li>
                        <a href="?p=<?php echo urlencode($page['co_id']); ?>" class="<?php echo $editing_page_file === $page['co_id'] ? 'active' : ''; ?>"><?php echo htmlspecialchars($page['co_subject']); ?></a>
            ...
            <form method="post" style="padding: 0.5rem 0;">
                ...
                <input type="text" name="new_page_id" placeholder="페이지 ID (영문, 숫자, -)" required style="width: 100%; box-sizing: border-box; padding: 0.5rem; margin-bottom: 0.5rem;">
                <button type="submit" name="create_dynamic_page">생성</button>
            </form>
        </aside>
